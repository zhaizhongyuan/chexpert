...
class MultiLabelDataModule(pl.LightningDataModule):
    def __init__(self, data_dir, batch_size=16, num_workers=4):
        ...
        # config and transform for Xception
        dummy_model = timm.create_model('xception', pretrained=True)
...
model = LitXceptionMultiLabel(num_classes=14)
...
wandb_logger = WandbLogger(project="chexpert_multilabel", name="xception_lr_5e-5_batch_size_16")
